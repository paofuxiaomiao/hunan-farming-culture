...
export const solarTerms: SolarTerm[] = [
  { id: 'st-1', name: '立春', icon: '/manus-storage/solar-lichun_fffd11ab.png', season: 'spring' },
  { id: 'st-2', name: '雨水', icon: '/manus-storage/solar-lichun_fffd11ab.png', season: 'spring' },
  { id: 'st-3', name: '惊蛰', icon: '/manus-storage/solar-lichun_fffd11ab.png', season: 'spring' },
  { id: 'st-4', name: '春分', icon: '/manus-storage/solar-lichun_fffd11ab.png', season: 'spring' },
  { id: 'st-5', name: '清明', icon: '/manus-storage/solar-qingming_ce50dc18.png', season: 'spring' },
  { id: 'st-6', name: '谷雨', icon: '/manus-storage/solar-qingming_ce50dc18.png', season: 'spring' },
  { id: 'st-7', name: '立夏', icon: '/manus-storage/solar-mangzhong_8c62636e.png', season: 'summer' },
  { id: 'st-8', name: '小满', icon: '/manus-storage/solar-mangzhong_8c62636e.png', season: 'summer' },
  { id: 'st-9', name: '芒种', icon: '/manus-storage/solar-mangzhong_8c62636e.png', season: 'summer' },
  { id: 'st-10', name: '夏至', icon: '/manus-storage/solar-xiazhi_af1c9ff8.png', season: 'summer' },
  { id: 'st-11', name: '小暑', icon: '/manus-storage/solar-xiazhi_af1c9ff8.png', season: 'summer' },
  { id: 'st-12', name: '大暑', icon: '/manus-storage/solar-xiazhi_af1c9ff8.png', season: 'summer' },
  { id: 'st-13', name: '立秋', icon: '/manus-storage/solar-liqiu_2813e36f.png', season: 'autumn' },
  { id: 'st-14', name: '处暑', icon: '/manus-storage/solar-liqiu_2813e36f.png', season: 'autumn' },
  { id: 'st-15', name: '白露', icon: '/manus-storage/solar-bailu_458b7175.png', season: 'autumn' },
  { id: 'st-16', name: '秋分', icon: '/manus-storage/solar-bailu_458b7175.png', season: 'autumn' },
  { id: 'st-17', name: '寒露', icon: '/manus-storage/solar-hanshou_3ae7fa04.png', season: 'autumn' },
  { id: 'st-18', name: '霜降', icon: '/manus-storage/solar-hanshou_3ae7fa04.png', season: 'autumn' },
  { id: 'st-19', name: '立冬', icon: '/manus-storage/solar-daxue_68cbf7ff.png', season: 'winter' },
  { id: 'st-20', name: '小雪', icon: '/manus-storage/solar-daxue_68cbf7ff.png', season: 'winter' },
  { id: 'st-21', name: '大雪', icon: '/manus-storage/solar-daxue_68cbf7ff.png', season: 'winter' },
  { id: 'st-22', name: '冬至', icon: '/manus-storage/solar-daxue_68cbf7ff.png', season: 'winter' },
  { id: 'st-23', name: '小寒', icon: '/manus-storage/solar-daxue_68cbf7ff.png', season: 'winter' },
  { id: 'st-24', name: '大寒', icon: '/manus-storage/solar-daxue_68cbf7ff.png', season: 'winter' },
];
